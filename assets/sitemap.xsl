	...
	<xsl:template match="/">
		...
		<div id="content">
			...
			<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
				<p class="expl">
					There are <xsl:value-of select="count(sitemap:urlset/sitemap:url)"/> URLs on this site.
				</p>
				<table id="sitemap" cellpadding="3">
					<thead>
					<tr>
						...
						<th title="Published Time" width="12.5%">Pub Date.</th>
						<th title="Last Modification Time" width="12.5%">Last Mod.</th>
					</tr>
					</thead>
					<tbody>
